...
export class SignalResponse extends Message<SignalResponse> {
  ...
  message: {
     ...
     *
     * @generated from field: livekit.RequestResponse request_response = 23;
     */
     ...
     *
     * @generated from field: livekit.TrackSubscribed track_subscribed = 24;
     */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 23, name: "request_response", kind: "message", T: RequestResponse, oneof: "message" },
    { no: 24, name: "track_subscribed", kind: "message", T: TrackSubscribed, oneof: "message" },
  ]);
...
export class DeviceInfo extends Message<DeviceInfo> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "livekit.DeviceInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
