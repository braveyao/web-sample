...
export interface TrackPublishDefaults {
  ...
  backupCodec?:
    | true
    | false
    | { codec: BackupVideoCodec; encoding?: VideoEncoding };
...
export const VideoPresets = {
  ...
  h540: new VideoPreset(960, 540, 500_000, 25),
  h720: new VideoPreset(1280, 720, 1_250_000, 30),
...
export const VideoPresets43 = {
  ...
  h540: new VideoPreset(720, 540, 550_000, 25),
  h720: new VideoPreset(960, 720, 1_200_000, 30),
