import { DataPacket, DataPacket_Kind, DisconnectReason, ParticipantInfo, Room as RoomModel, SpeakerInfo, TrackInfo, Transcription } from '../proto/livekit_models_pb';
import { AddTrackRequest, ConnectionQualityUpdate, JoinResponse, RequestResponse, StreamStateUpdate, SubscribedQualityUpdate, SubscriptionPermissionUpdate, SubscriptionResponse, TrackUnpublishedResponse } from '../proto/livekit_rtc_pb';
...
export default class RTCEngine extends RTCEngine_base {
    ...
    private disconnectStartTimePrimary;
    private disconnectStartTimeSecondary;
