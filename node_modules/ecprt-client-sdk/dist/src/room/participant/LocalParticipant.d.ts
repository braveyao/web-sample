import { Codec, ParticipantInfo, ParticipantPermission } from '../../proto/livekit_models_pb';
...
export default class LocalParticipant extends Participant {
   ...
   */
     ...
     */
    performRpc(destinationIdentity: string, method: string, payload: string, responseTimeoutMs?: number): Promise<string>;
    /**
     ...
     */
    registerRpcMethod(method: string, handler: (requestId: string, callerIdentity: string, payload: string, responseTimeoutMs: number) => Promise<string>): void;
    /**
