import { DataPacket_Kind, ParticipantInfo, ParticipantInfo_Kind as ParticipantKind, ParticipantPermission, ConnectionQuality as ProtoQuality, type SipDTMF, SubscriptionError } from "../../proto/livekit_models_pb";
...
export default class Participant extends Participant_base {
    ...
    private _qualityChangeTimeout?;
    private _lastProtoQuality?;
     ...
     **/
    protected _setMetadata(md: string): void;
