import { Track } from "ecprt-client-sdk";
import type { AudioProcessorOptions, Room, TrackProcessor } from "ecprt-client-sdk";
import { DenoiseOptions } from "./options";
export type DenoiseFilterOptions = DenoiseOptions;
export declare class DenoiseProcessor implements TrackProcessor<Track.Kind.Audio, AudioProcessorOptions> {
    #private;
